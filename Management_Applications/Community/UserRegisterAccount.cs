...
namespace PKDSA_UMWinClient
{
    public partial class UserRegisterAccount : Form
    {
        ...
        {
            if (UserIDTB.Text.CompareTo("") != 0 && PublicKeyTB.Text.CompareTo("") != 0 && SignedPublicKeyTB.Text.CompareTo("") != 0)
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    var response = client.GetAsync("RegisterAccount?User_ID=" + UserID + "&URLEncoded_Master_Signed_PK=" + System.Web.HttpUtility.UrlEncode(SignedPublicKey) + "&URLEncoded_Master_PK=" + System.Web.HttpUtility.UrlEncode(PublicKey));
                    response.Wait();
            ...
            {
                MessageBox.Show("You didn't generate any information or keys locally", "Denying Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
