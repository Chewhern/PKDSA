...
namespace PKDSA_ServerApp.Controllers
{
    ...
    public class RegisterAccount : ControllerBase
    {
        ...
        [HttpGet]
        public RegisterModel CreateAccount(String User_ID,String Session_ID,String URLEncoded_Master_Signed_PK,String URLEncoded_Master_PK)
        {
            ...
            if (DecodingMaster_Signed_PK == true && DecodingMaster_PK == true)
            {
                ...
                {
                    MyRegisterModel.Status = "Error: Session's Messenger's user ID must be hexadecimal and don't use any other data";
